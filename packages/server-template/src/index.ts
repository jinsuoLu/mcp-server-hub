 ...
 */
import{Server,StdioServerTransport,CallToolRequestSchema,ListToolsRequestSchema}from"@mcp-hub/shared";import{success,error,requireParam}from"@mcp-hub/shared";
...
async function main(){const transport=new StdioServerTransport();await server.connect(transport);console.error("🏷�?MCP Template Server running on stdio")}
